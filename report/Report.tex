...
The program skips malformed CSV rows, returns $-1$ for unknown dictionary values (causing an empty result), and reports ``No result'' when no valid $(x, y)$ pairs are found.
